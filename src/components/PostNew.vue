...
import type { PostsData } from '../helpers/PostsData'
import { postContent } from '../helpers/PostsData'
...
const onSubmit= async() => {
    ...
    await postContent(accessToken, postForm.value)
    .then(() => {
            toast.success("¡Post correcto!", {
                autoClose:1000,
            })
